...
public class S06_SoftwareRasterizer_Finish : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 vertexA = new Vector2(30, 220);
    [SerializeField] private Vector2 vertexB = new Vector2(20, 40);
    [SerializeField] private Vector2 vertexC = new Vector2(240, 90);
    [SerializeField] private Color fillColor = new Color(0.2f, 0.6f, 1f, 1f);
    [SerializeField] private Color backgroundColor = new Color(0.05f, 0.05f, 0.15f, 1f);
